...
import com.mars.common.core.domain.entity.SysDictType;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public List<SysDictData> selectDictDataByType(String dictType) {
        ...
        if (LocalStringUtils.isNotEmpty(dictDatas)) {
            return dictDatas;
        }
    ...
    public String checkDictTypeUnique(SysDictType dict) {
        Long dictId = LocalStringUtils.isNull(dict.getDictId()) ? Long.valueOf(-1L) : dict.getDictId();
        SysDictType dictType = dictTypeMapper.checkDictTypeUnique(dict.getDictType());
        if (LocalStringUtils.isNotNull(dictType) && dictType.getDictId().longValue() != dictId.longValue()) {
    ...
    public Map<String, String> selectDictDataMapByType(String dictType) {
        ...
        if (LocalStringUtils.isNotEmpty(dictDataList)) {
