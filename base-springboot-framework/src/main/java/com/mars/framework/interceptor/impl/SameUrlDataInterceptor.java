package com.mars.framework.interceptor.impl;
...
import com.mars.common.filter.RepeatedlyRequestWrapper;
import com.mars.common.utils.LocalStringUtils;
import com.mars.common.utils.http.HttpHelper;
import com.mars.framework.interceptor.BaseRepeatSubmitInterceptor;
...
public class SameUrlDataInterceptor extends BaseRepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request) {
        ...
        if (LocalStringUtils.isEmpty(nowParams)) {
        ...
        if (LocalStringUtils.isEmpty(submitKey)) {
            submitKey = url;
        }
    ...
    private boolean compareTime(Map<String, Object> nowMap, Map<String, Object> preMap) {
        ...
        int number = 1000;
        if ((time1 - time2) < (this.intervalTime * number)) {
            return true;
        }
        return false;
    }
