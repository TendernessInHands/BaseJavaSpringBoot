...
public class UserConstants {
     ...
     *  菜单类型（模块）
     */
    public static final String TYPE_MODEL = "K";
    ...
    public static final String SYS_ADMIN_ROLE_CODE = "systemAdmin";
    ...
    public static final String DEFAULT_PASSWORD = "MarsPower@2023";
    public static final String ADMIN_PASSWORD = "A12345aaa*";
}
