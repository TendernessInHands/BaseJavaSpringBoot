...
public class SysRoleController extends BaseController {
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role) {
        ...
        if (roleService.updateRole(role) > 0) {
            ...
            if (LocalStringUtils.isNotNull(loginUser.getUser()) && !loginUser.getUser().isAdmin()) {
                loginUser.setPermissions(permissionService.getMenuPermission(loginUser.getUser(), "0"));
